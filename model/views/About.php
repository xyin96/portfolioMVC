...
class About {
    public function __construct(){
        ...
        print '<section>';
        print '<table> <tr> <td class="collapse-mobile profile"> <img src="assets/images/me.png" width="100%" alt=""/> </td> <td style="padding:25px"> <h1 class="title">Xiaoyu Yin</h1> <h3>Software Engineer - Web Developer</h3> <p>I am a...</p> <ul> <li>student studying Computer Science at the University of Maryland (expected graduation: May 2018)</li> <li>always looking for new technologies to learn, and ways to improve current technologies</li> </ul> <p>Please feel free to <a href="?url=Contact">drop a message</a>, or <a href="Resume.pdf" target="_blank">review my Resume!</a></p><br /> <ul class="handles"> <li><div><a href="https://www.facebook.com/xiaoxiao13" target="_blank"><img src="assets/images/facebook.png" width="75px" /></a></div></li> <li><div><a href="https://github.com/xyin96" target="_blank"><img src="assets/images/github.png" width="75px" /></a></div></li> <li><div><a href="https://www.linkedin.com/profile/view?id=307669414" target="_blank"><img src="assets/images/linkedin.png" width="75px" /></a></div></li> <li><div><a href="http://challengepost.com/users/xyin" target="_blank"><img src="assets/images/challengepost.png" width="75px" /></a></div></li> </ul></td> </tr> </table>';
